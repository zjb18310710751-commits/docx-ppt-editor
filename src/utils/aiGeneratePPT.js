...
const TOPIC_PATTERNS = [
  { keys: ['商务', '企业', '公司', '商业', '汇报', '年度', '季度', '战略', '管理', '销售', '业绩', '市场', '提案', '咨询', '分析'], cat: 'WPS精选', prefer: ['黑金商务', '星空蓝', '麦肯锡蓝'] },
  { keys: ['科技', '技术', 'AI', '人工智能', '软件', '代码', '程序', '算法', '数据', '架构', '开发', '编程', '互联网', '云', '安全', '新能源', '硬件', '发布'], cat: 'WPS精选', prefer: ['碳纤维', '星空蓝', '科技蓝调'] },
  { keys: ['时尚', '美妆', '奢侈', '品牌', '设计', '艺术', '潮流', '杂志', '创意'], cat: 'WPS精选', prefer: ['玫瑰金', '质感杂志', '孟菲斯风格'] },
  { keys: ['文化', '中国', '传统', '国风', '历史', '非遗', '手工艺', '书法', '绘画'], cat: 'WPS精选', prefer: ['水墨江南', '故宫红墙', '青花瓷'] },
  { keys: ['简约', '极简', '苹果', '发布会', '产品'], cat: 'WPS精选', prefer: ['极简留白', '莫兰迪绿', '纯白极简'] },
